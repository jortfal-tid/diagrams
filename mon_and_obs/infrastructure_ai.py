...
with Diagram("Infrastructure Architecture >> AI to Observability", direction="TB", filename="mon_and_obs_infrastucture_ai", show=False):
    ...
    with Cluster("Node Pool AI"):
      ...
      nodes_ai = [node_ai01, node_ai02, node_ai03]
    ...
    with Cluster("NODE AI03 | Standard_NC16as_T4_v3​"):

      aks_node_ai03 = KubernetesServices("Node AI03​")
      ai_03 = Custom("AI Models", "./assets/img/ai-logo.png")
